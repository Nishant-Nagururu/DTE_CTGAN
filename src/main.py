...
def parse_arguments():
    ...
    parser.add_argument('--base_path', type=str, default='/blue/dream_team/CT_GAN_TEAM/DTE_CTGAN/', help='Base path for the data and output folders')
    ...
    parser.add_argument('--data_path', type=str, default='Inputs/Covid/', help='Path to the covid dataset')
    parser.add_argument('--healthy_data_path', type=str, default='Inputs/Healthy/', help='Path to healthy data')
